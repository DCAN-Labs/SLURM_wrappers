...
data_dir="/tmp/eLABE" # where to output data
...
run_folder="/home/faird/shared/projects/eLABE_probabilistic_baby_atlas_processing/slurm_dcan_infantwrapper_beginning"
